...
def multitransp(A):
    ...
    # be an array containing M matrices, each of which has dimension N x P. That
    # is, A is an M x N x P array. Multitransp then returns an array containing
    # the M matrix transposes of the matrices in A, each of which will be P x N.
