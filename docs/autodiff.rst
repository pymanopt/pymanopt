...
:class:`pymanopt.manifolds.FixedRankEmbedded` manifold are not represented as
``m x n`` matrices in the ambient space but as a singular value decomposition.
...
:func:`pymanopt.autodiff.make_tracing_backend_decorator`.
